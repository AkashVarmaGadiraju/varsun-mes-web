			...
			<div className="p-4 pt-2 space-y-2">
				...
				<div className="grid grid-cols-2 !gap-3">
					<AssignmentField label="Machine">
						<AssignmentSelect value={data.machine} onChange={(e) => handleChange("machine", e.target.value)} disabled={readOnly}>
				...
				<div className="!space-y-1.5">
					...
					<div
						className={`flex !gap-2 bg-primary/5 !p-3 rounded-lg border transition-colors ${
							errors.shift ? "border-red-500 bg-red-50" : "border-primary/10"
						}`}
					>
